...
class _SettingsScreenState extends State<SettingsScreen> {
    ...
    return ListView(
      ...
      children: [
        ...
        const ListTile(
          ...
          title: Text('PP1 Study',
              style: TextStyle(fontWeight: FontWeight.w700)),
          subtitle: Text(
              'Offline PCPP1 (PCPP-32-101) Python + Go zero-to-hero course.\n'
  ...
  Future<String> _export(AppState s) async {
    ...
    final file = File('${dir.path}/pp1_progress_export.json');
  ...
  Future<void> _confirmWipe(AppState s) async {
    ...
    if (ok == true && mounted) {
      final dir = await getApplicationDocumentsDirectory();
      final db = File('${dir.path}/pp1study.db');
